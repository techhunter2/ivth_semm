...
function saveEmployee() {
    ...
    var putReqStr = createPUTRequest(token,jsonStr, "3rdfeedbackdb2k22", "t1");
    // alert(putReqStr);
...
function saveEmployee2() {
    ...
    var putReqStr = createPUTRequest(token,jsonStr, "3rdfeedbackdb2k22", "t2");
    // alert(putReqStr);
    jQuery.ajaxSetup({ async: false });
    var resultObj = executeCommand(putReqStr,"http://api.login2explore.com:5577", "/api/iml");
    // alert(JSON.stringify(resultObj));
...
function saveEmployee3() {
    ...
    var putReqStr = createPUTRequest(token,jsonStr, "3rdfeedbackdb2k22", "t3");
    // alert(putReqStr);
    jQuery.ajaxSetup({ async: false });
    var resultObj = executeCommand(putReqStr,"http://api.login2explore.com:5577", "/api/iml");
    // alert(JSON.stringify(resultObj));
...
function saveEmployee4() {
    ...
    var putReqStr = createPUTRequest(token,jsonStr, "3rdfeedbackdb2k22", "t4");
    // alert(putReqStr);
    jQuery.ajaxSetup({ async: false });
    var resultObj = executeCommand(putReqStr,"http://api.login2explore.com:5577", "/api/iml");
    // alert(JSON.stringify(resultObj));
...
function saveEmployee5() {
    ...
    var putReqStr = createPUTRequest(token,jsonStr, "3rdfeedbackdb2k22", "t5");
    // alert(putReqStr);
    jQuery.ajaxSetup({ async: false });
    var resultObj = executeCommand(putReqStr,"http://api.login2explore.com:5577", "/api/iml");
    // alert(JSON.stringify(resultObj));
...
function saveEmployee6() {
    ...
    var putReqStr = createPUTRequest(token,jsonStr, "3rdfeedbackdb2k22", "t6");
    // alert(putReqStr);
    jQuery.ajaxSetup({ async: false });
    var resultObj = executeCommand(putReqStr,"http://api.login2explore.com:5577", "/api/iml");
    // alert(JSON.stringify(resultObj));
